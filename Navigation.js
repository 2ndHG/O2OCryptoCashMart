...
//我自己做的
import LoginPage from './happyPage/LoginPage';
import HomePage from'./happyPage/HomePage';
import UploadingPage from './happyPage/UploadingPage'
import MerchantListPage from './happyPage/MerchantListPage'
import ShopPage from './happyPage/ShopPage'
import MyShopPage from './happyPage/MyShopPage'
import CartPage from './happyPage/CartPage'
import RecordPage from './happyPage/RecordPage'
import DelivererPage from './happyPage/DelivererPage'
...
const WalletsRoot = () => {
  ...
  return (
    <WalletsStack.Navigator {...(Platform.OS === 'android' ? { screenOptions: defaultScreenOptions } : null)}>
      ...
      <WalletsStack.Screen name="LoginPage" component={LoginPage} options={WalletsList.navigationOptions(theme)} />
      <WalletsStack.Screen name="HomePage" component={HomePage} options={WalletsList.navigationOptions(theme)} />
      <WalletsStack.Screen name="UploadingPage" component={UploadingPage} options={WalletsList.navigationOptions(theme)} />      
      <WalletsStack.Screen name="MerchantListPage" component={MerchantListPage} options={WalletsList.navigationOptions(theme)} />
      <WalletsStack.Screen name="ShopPage" component={ShopPage} options={WalletsList.navigationOptions(theme)} />
      <WalletsStack.Screen name="MyShopPage" component={MyShopPage} options={WalletsList.navigationOptions(theme)} />
      <WalletsStack.Screen name="CartPage" component={CartPage} options={WalletsList.navigationOptions(theme)} />
      <WalletsStack.Screen name="RecordPage" component={RecordPage} options={WalletsList.navigationOptions(theme)} />
      <WalletsStack.Screen name="DelivererPage" component={DelivererPage} options={WalletsList.navigationOptions(theme)} />
